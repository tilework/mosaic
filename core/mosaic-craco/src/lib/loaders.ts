    ...
    if (rule) {
      if (matcher(rule)) {
        ...
        if (rule.use) {
          ...
          loader = getLoaderRecursively(rule.oneOf as RuleSetRule[], matcher);
    ...
    if (rule) {
      if (matcher(rule)) {
        ...
        if (rule.use) {
          ...
          getLoadersRecursively(rule.oneOf as RuleSetRule[], matcher, matchingLoaders);
        } else if (isArray(rule.loader)) {
    ...
    if (rule) {
      if (matcher(rule)) {
        ...
        if (rule.use) {
          ...
          const result = removeLoadersRecursively(rule.oneOf  as RuleSetRule[], matcher);
